...
5. **Normalize + clip reward signal** before prompt updates for stability in early iterations.
6. **Optimize prompts** using this downstream reward signal plus weak-query quality.
